    ...
    return (
        <SafeAreaView style={{ flex: 1 }}>
            ...
            <View style={authStyles.header}>
                ...
                <Text style={authStyles.welcomeBack}>Forgot Password!</Text>
                <Text style={authStyles.subText}>Please enter your registerd email to get an OTP and reset password.</Text>
